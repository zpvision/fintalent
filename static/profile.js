...
(async()=>{
 try{
  ...
  document.querySelectorAll('.resume-action,.welcome-resume').forEach(link=>{
   ...
   link.href=`/profiles/view/${resume.id}`;
...
(()=>{
 ...
 const fire='<img class="menu-fire" src="/static/icons/fire.svg?v=1" alt="" aria-hidden="true">';
