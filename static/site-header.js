(function(){
  ...
  header.innerHTML=`<a class="ft-brand" href="/"><span class="ft-logo-crop"><img src="/static/logo.png" alt=""></span><span class="ft-brand-copy"><b>Fin<span>Talent</span></b><small>Биржа вакансий для бухгалтеров</small></span></a><button class="ft-menu-toggle" type="button" aria-label="Открыть меню">☰</button><nav class="ft-main-nav"><a class="${active('/vacancies')?'active':''}" href="/vacancies/create">Вакансии</a><a class="${active('/resume')?'active':''}" href="/resume/create">Резюме</a><a href="#">Компании</a><a class="${active('/marketplace')||active('/tests')?'active':''}" href="/marketplace">Тесты и навыки</a><a href="#">Блог</a><a href="#">Цены</a></nav><div class="ft-account"><a class="ft-login" href="/login">Войти</a><a class="ft-register" href="/register">Регистрация</a></div>`;
