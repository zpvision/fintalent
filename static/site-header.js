(function(){
  ...
  header.innerHTML=`<a class="ft-brand" href="/"><span class="ft-logo-crop"><img src="/static/logo.png" alt=""></span><span class="ft-brand-copy"><b>Fin<span>Talent</span></b><small>Биржа вакансий для бухгалтеров</small></span></a><button class="ft-menu-toggle" type="button" aria-label="Открыть меню">☰</button><nav class="ft-main-nav"><a class="${active('/vacancies')?'active':''}" href="/vacancies">Вакансии</a><a class="${active('/resumes')||active('/resume')?'active':''}" href="/resumes">Резюме</a><a class="${active('/marketplace')||active('/tests')?'active':''}" href="/marketplace">Тесты</a><a class="${active('/profimarket')?'active':''}" href="/profimarket">ПрофиМаркет</a><a class="${active('/publications')?'active':''}" href="/publications">Публикации</a><a href="#">Сообщество</a></nav><div class="ft-account"><a class="ft-login" href="/login">Войти</a><a class="ft-register" href="/register">Регистрация</a></div>`;
