...
func registerAdminRoutes() {
	...
	http.HandleFunc("/api/admin/community/vacancies", adminCommunityVacancies)
	http.HandleFunc("/api/admin/community/vacancies/", adminCommunityVacancyAction)
	http.HandleFunc("/api/admin/community/profiles", adminCommunityProfiles)
	http.HandleFunc("/api/admin/community/profiles/", adminCommunityProfileAction)
	...
	http.HandleFunc("/api/admin/profimarket/compatibility", adminProfiMarketCompatibilityOptions)
	http.HandleFunc("/api/admin/profimarket/compatibility/", adminProfiMarketCompatibilityOptionItem)
