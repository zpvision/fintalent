...
export const getContactThreads = options => apiClient.get('/api/v1/contact-threads', options)
export const getContactMessages = (id, options) => apiClient.get(`/api/v1/contact-threads/${encodeURIComponent(id)}/messages`, options)
export const sendContactMessage = (id, message, options) => apiClient.post(`/api/v1/contact-threads/${encodeURIComponent(id)}/messages`, { message }, options)
export const runContactAction = (id, action, payload = null, options) => apiClient.post(`/api/v1/contact-threads/${encodeURIComponent(id)}/${action}`, payload, options)
