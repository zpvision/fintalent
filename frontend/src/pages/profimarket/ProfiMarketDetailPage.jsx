...
function loadPresentation() {
  if (window.ProfiMarketUI?.version >= 34) return Promise.resolve(window.ProfiMarketUI)
  if (!uiPromise) uiPromise = new Promise((resolve, reject) => {
    ...
    const loadComponents = () => load('/static/profimarket-components.js?v=34', () => resolve(window.ProfiMarketUI))
