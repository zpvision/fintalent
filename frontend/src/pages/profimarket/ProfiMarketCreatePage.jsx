...
export default function ProfiMarketCreatePage() {
  usePageStyles(['/static/profimarket.css?v=1', '/static/profimarket-ai-editor.css?v=2']); useDocumentPage({ title: 'Разместить решение — ПрофиМаркет' })
