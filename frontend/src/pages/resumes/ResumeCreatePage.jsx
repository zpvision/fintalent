...
export default function ResumeCreatePage() {
  ...
  return <><header className="resume-header"><a className="resume-brand" href="/"><span>F</span><b>Fin <em>Talent</em></b></a><div className="header-title"><b>Создание профиля</b><small>Быстрое создание</small></div><a className="cancel" href="/">× Отменить</a><button className="help">? Нужна помощь?</button></header>
