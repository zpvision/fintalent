...
export default function ResumeCreatePage() {
  ...
  return <><header className="resume-header"><div className="header-title"><b>Создание резюме</b><small>Быстрое создание</small></div><a className="cancel" href="/">× Отменить</a></header>
